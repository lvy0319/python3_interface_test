...
class GetData:
    ...
    def get_header_value(self, row):
        oper_json = OperationJson(r'E:\pyScript\python3_interface-master\dataconfig\request_header.json')
    ...
    def get_data_value(self,row):
        oper_json = OperationJson(r'E:\pyScript\python3_interface-master\dataconfig\request_data.json')
