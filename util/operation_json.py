...
class OperationJson():
    ...
    def write_data(self, data):
        with open(r'E:\pyScript\python3_interface-master\dataconfig\cookie.json', 'w') as fp:
            fp.write(json.dumps(data))


if __name__ == '__main__':
    opjson = OperationJson(r'E:\pyScript\python3_interface-master\dataconfig\request_data.json')
