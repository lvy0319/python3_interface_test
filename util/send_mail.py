...
class SendEmail:
    ...
    send_user = "cu_bbss_lvyang@126.com"
    ...
    def send_mail(self,user_list,sub,content):
        ...
        # 构造附件（附件为txt格式的文本）
        filename = r'E:\pyScript\python3_interface-master\log\log.txt'
        ...
        #server.connect(email_host,465)# qq邮箱的话需要启用SSL发信, 端口一般是465
